...
"""
    ...
    sinphi = np.sin(phi)
    r = np.asarray([
        [ux*ux*(1-cosphi)+ 1*cosphi, uy*ux*(1-cosphi)-uz*sinphi, uz*ux*(1-cosphi)+uy*sinphi],
        [ux*uy*(1-cosphi)+uz*sinphi, uy*uy*(1-cosphi)+ 1*cosphi, uz*uy*(1-cosphi)-ux*sinphi],
        [ux*uz*(1-cosphi)-uy*sinphi, uy*uz*(1-cosphi)+ux*sinphi, uz*uz*(1-cosphi)+ 1*cosphi],
        ])
    mat[:3, :3] = r
    return mat
