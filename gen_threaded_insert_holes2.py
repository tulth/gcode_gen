...
def main(argv):
    ...
    gcFileName = "threaded_insert_holes2_rough.gcode"
    ...
    gcFileName = "threaded_insert_holes2_drill.gcode"
    with open(gcFileName, 'w') as ofp:
    ...
    gcFileName = "threaded_insert_holes2_fine.gcode"
    with open(gcFileName, 'w') as ofp:
        ofp.write(fineAsm.genGcode())
    log.info("wrote {}".format(gcFileName))
    SCAD_OUT_FILE_NAME = "threaded_insert_holes2.scad"
