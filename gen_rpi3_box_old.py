...
# BOX_BASE_WIDTH = # OUTSIDE left face to right face distance MINUS 2xworkpiece thickness
# BOX_BASE_LENGTH = # OUTSIDE front face to back face distance MINUS 2xworkpiece thickness
BOX_BASE_HEIGHT = 27.963  # OUTSIDE top face to bottom face distance MINUS 2xworkpiece thickness, and not including feet

# WORKPIECE_THICKNESS = 0.125 * gc.number.mmPerInch
# WORKPIECE_THICKNESS = 0.2 * gc.number.mmPerInch
WORKPIECE_THICKNESS = 3
WORKPIECE_SIZE = (7.5 * gc.number.mmPerInch, 6.5 * gc.number.mmPerInch, WORKPIECE_THICKNESS)

BOX_HEIGHT = 27.963 + 2 * WORKPIECE_THICKNESS   # OUTSIDE top face to bottom face distance not including feet
...
class FrontOutlineCut(gc.assembly.Assembly):
    ...
    def _elab(self,
        ...
        yStart = 104.242 + 17
        ySteps = np.asarray((yStart, yStart + BOX_HEIGHT, yStart + BOX_HEIGHT + FOOT_HEIGHT))
...
class BackOutlineCut(gc.assembly.Assembly):
    ...
    def _elab(self,
        ...
        xSteps = np.asarray((L, L + FOOT_WIDTH, R - FOOT_WIDTH, R))
        yStart = 3.02204 + 5
        ySteps = np.asarray((yStart - FOOT_HEIGHT, yStart, yStart + BOX_HEIGHT))
        vertices = np.asarray(((xSteps[0], ySteps[0]),
                               (xSteps[1], ySteps[0]),
                               (xSteps[1], ySteps[1]),
                               (xSteps[2], ySteps[1]),
...
class rpi3_box_left_mill_C102(gc.assembly.Assembly):
    ...
    def _elab(self, ):
        ...
        yStart = 121.225
        outlineYs = (yStart, 123.236, 123.236 + TENON_WIDTH, 143.194, 143.194 + TENON_WIDTH, yStart + BOX_HEIGHT, )
        # outline cut out
